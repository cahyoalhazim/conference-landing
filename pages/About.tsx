  ...
  return (
    <div className="pt-24 min-h-screen bg-deepNavy">
      <div className="text-center py-10">
        <h1 className="text-5xl font-sans font-bold text-white mb-4">About & Scopes</h1>
        <p className="text-slate-400 text-lg">Exploring the frontiers of Biochemistry</p>
      </div>
      ...
      <section className="py-20 relative">
          <div className="container mx-auto px-6">
              <div className="text-center mb-12">
                  <h2 className="text-3xl font-sans font-bold text-white">Organizing Committee</h2>
                  <p className="text-slate-400 mt-2">The dedicated team behind ICBMB 2025</p>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
                  {committee.map((member, idx) => (
                      <div key={idx} className="glass-card p-6 rounded-2xl hover:bg-white/5 transition-colors">
                          <p className="text-xs font-bold text-bioCyan uppercase tracking-wide mb-2">{member.role}</p>
